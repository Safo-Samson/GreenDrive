...
const keywords = "hybrid vehicles";
...
fetch(url)
    ...
    .then(data => {
        const newsContainer = document.getElementById("hybrid-news-container");

        // Get the first 5 articles
        const firstFiveArticles = data.articles.slice(0, 5);

        // Loop through the first 5 articles and create a new element for each one
